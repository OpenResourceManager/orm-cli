...
class StateDeleteCommand extends APICommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'state:delete {id? : The state ID (optional)}
     ...
     * @var string
     */
    protected $description = 'Deletes a State by it\'s ID, or code.';
